...
const SuccessStoryCard = () => {
	return (
		<div className="bg-background p-6 relative flex sm:flex-row flex-col gap-6 rounded-2xl text-white embla__slide__number-scale">
			<div className="absolute top-4 right-4">
				<QuotesIcon />
			</div>
			<div className="sm:w-[277px] sm:h-[302px] rounded-lg overflow-hidden">
				<img
			...
			<div className="flex flex-col gap-4 sm:w-[60%] mt-6">
				<p>
